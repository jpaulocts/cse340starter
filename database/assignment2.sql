...
ALTER TYPE public.account_type OWNER TO cse340db1;
...
--Create relationshop between `classification` and `inventory` tables
...
-- #Task 1 Adding Tony Stark in account table
INSERT INTO account (
        account_firstname,
        account_lastname,
        account_email,
...
-- #Task 2 Updating the account_type in account table 
UPDATE account
SET account_type = 'Admin';
-- #Task 3 Removing Tony Stark from account table
DELETE FROM account
WHERE account_firstname = 'Tony';
-- #Task 4 UPDATE inventory  with new description
UPDATE inventory
